...
// with coordinates(x1, y1) and(x2, y2).Your task is to find out if 
// these vectors are collinear.Collinear vectors are vectors 
// that lie on the same straight line.They can be directed in the same 
// or opposite directions.One vector can be obtained from another by 
// multiplying it by a certain number.In terms of coordinates, 
